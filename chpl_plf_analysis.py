...
# Assign variables for needed values
circ = chpl["Circ YTD"]
...
# Calculate the sum of all CHPL usage by year
chpl_totals = chpl.sum(axis=1)

# Set general seaborn and pyplot styles/visuals
sns.set()
plt.style.use("ggplot")

# Create subplots and set the overall figure size
fig, (ax1, ax2) = plt.subplots(2,1)
fig.set_figheight(8.5)
fig.set_figwidth(9)

# Create first horizontal bar chart showing Public Library Fund amount awarded to Hamilton County
hor1 = ax1.barh(year, plf)

# Formatting ticks and lables for first chart
ax1.ticklabel_format(style='plain')
ax1.tick_params(axis='both', labelsize=10)
ax1.tick_params(axis='x', labelrotation=45)
ax1.set_yticks(ticks=year)

# Adding titles and labels to subplot and bars
...
# Legend and tick formatting for the second chart
